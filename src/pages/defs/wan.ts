...
export const dualWanPage: SettingsPageDef = {
  ...
  title: 'Second Connection & Failover',
  navGroup: 'wan',
  navOrder: 18,
...
export const portTriggerPage: SettingsPageDef = {
  ...
  title: 'Dynamic Port Opening (Port Trigger)',
  navGroup: 'security',
  navSub: 'inbound',
  navOrder: 25,
  confidence: { read: 'structural', write: 'unverified-write' },
...
export const natPassthroughPage: SettingsPageDef = {
  ...
  title: 'Protocol Passthrough (VPN / SIP / RTSP)',
  navGroup: 'security',
  navSub: 'inbound',
  navOrder: 27,
  confidence: { read: 'structural', write: 'unverified-write' },
